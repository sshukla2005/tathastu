...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles for Latest at Tathastu';
...
export interface ApiClientLogoClientLogo extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Partner and client brand logos';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Academy courses & videos, shared by the Academy hub teaser and the full Courses & Videos catalog page';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
  ...
  attributes: {
    ...
    details: Schema.Attribute.DynamicZone<
      ['course-details.standard', 'course-details.houdini']
    > &
    ...
    level: Schema.Attribute.Enumeration<['Beginner', 'Intermediate']> &
...
export interface ApiCoursesPageCoursesPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Academy Courses & Videos catalog page \u2014 hero content; the course grid itself comes from the Course collection';
    displayName: 'Courses & Videos Page';
  ...
  attributes: {
    breadcrumbLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Courses & Videos'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage content managed via Dynamic Zone';
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industry verticals served by Tathastu';
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Form submissions from Contact, Demo, and Consultation forms';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    source: Schema.Attribute.Enumeration<['Contact', 'Demo', 'Consultation']> &
      Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<
...
export interface ApiPortfolioItemPortfolioItem
  ...
  info: {
    description: 'Hardware, software, and plugin products';
  ...
  attributes: {
    body: Schema.Attribute.Blocks;
    category: Schema.Attribute.Enumeration<['Hardware', 'Software', 'Plugin']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings: nav, footer, contact info';
...
export interface ApiStatStat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Stats for the homepage stats band';
    displayName: 'Stat';
    pluralName: 'stats';
    singularName: 'stat';
  };
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tathastu team profiles';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Words of Trust customer quotes';
